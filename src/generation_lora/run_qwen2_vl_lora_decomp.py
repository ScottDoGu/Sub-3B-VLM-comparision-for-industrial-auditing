"""
Qwen2-VL-2B + LoRA Adapter + Rule Decomposition (no CLAHE)
Tests the LoRA fine-tuned vision encoder with the structured Q1/Q2/Q3
decomposition prompt used in the decomposition phase.
"""
import torch
...
for run_i in range(1, N_RUNS + 1):
    ...
    print(f"\n--- Starting LoRA+Decomp Run {run_i}/{N_RUNS} on {len(dataset)} images ---")
    ...
    for i, item in enumerate(dataset):
        ...
        # Rule Decomposition Prompt (identical to generation_decomposition)
        decomp_prompt = (
    ...
    save_results(results, "qwen2_vl_lora_decomp", iteration=run_i, out_dir="results/innovation/lora")
